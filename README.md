# [Vue Resume Template](https://github.com/evemf/myresume/) by Evelia Molina
...
Check out a live version of the template **[here](https://github.com/evemf/myresume/).**
...
```scss
$primary: #cb309a; /** changing the 'primary' color to pink **/
$dark: #41042e; /** changing the 'dark' color to a dark shade of pink **/
...
```json
{
    "supportedLanguages": [
...

        {
            "name": "Català",
            "id": "ca",
            "flagUrl": "images/flags/cat.png"
        }  
    ]
}
```

The `public/images/flags/` it contains a collection of flags for commonly used languages.

Keepinhg a single language within the array will automatically hide the language picker menu.
...
```json 
{
    "en": {
     ...
     "es": {
        "section1_id": "Sección 1 ID",
        "section2_id": "Sección 2 ID",
        "section3_id": "Sección 3 ID"
    },
}
```
...
In simple terms, if you consider GitHub hosting the GitHub Pages site for this repo at the URL `https://evemf.github.io/cv-convue/`, the correct base directory to set is `/cv-convue/`.
...
This template was created by and is maintained by **[Evelia Molina](https://eveliamolina.com/)**.
